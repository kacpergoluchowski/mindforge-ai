...
export default function LandingFooter() {
  return (
    <footer id="about" className="px-6 pb-10 pt-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 flex flex-col gap-6 rounded-3xl border border-violet-400/20 bg-violet-500/10 p-6 sm:flex-row sm:items-center sm:justify-between lg:p-8">
