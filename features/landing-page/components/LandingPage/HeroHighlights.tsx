...
// Krótki pasek wartości pod hero.
// Działa jak szybkie podsumowanie produktu dla osób, które tylko skanują stronę.
    ...
    <div className="mx-auto mt-10 grid max-w-7xl gap-0 overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] md:grid-cols-4 lg:mt-16">
      {heroHighlights.map(({ title, description, icon: Icon }, index) => (
        <AnimatedSection
          ...
          delay={index * 0.06}
        >
          <Icon aria-hidden="true" className="size-8 text-violet-400" />
