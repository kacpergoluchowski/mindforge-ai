...
// Sticky header zostaje widoczny podczas scrollowania.
// Tło jest prawie nieprzezroczyste, żeby nie mieszało się z hero przy scrollTop = 0.
export default function LandingHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-white/5 bg-[#020617]/95 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        <Link
          href="/"
          aria-label="MindForge AI home"
          className="w-[130px] sm:w-auto [&_img]:w-full"
        >
          <Logo />
        </Link>

        {/* Linki prowadzą do sekcji na tej samej stronie, więc zwykły <a> jest tu poprawny. */}
        <nav
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/login"
            aria-label="Sign in to MindForge AI"
          ...
          <Link
            href="/register"
            aria-label="Create a free MindForge AI account"
